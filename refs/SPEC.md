...
**Status:** normative · **Contract version:** `v1` · supersedes `archive/02_grpc_routing_metadata_spec.md`.
...
the design rationale are in [`CONTEXT.md`](CONTEXT.md); run procedure in
[`example/TESTING.md`](example/TESTING.md).
